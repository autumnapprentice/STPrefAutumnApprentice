...
class CsNprFormatCommand(sublime_plugin.TextCommand):
    def __init__(self, view):
        ...
        self.unvtranspath = start + '\\CS NPR Tools\\'
    ...
    def run(self, view):
        ...
        toolspath = self.unvtranspath + 'LaunchNprTool.mas"'
        cmdprefix = magicpath + ' ' + toolspath + ' -tool Format'
